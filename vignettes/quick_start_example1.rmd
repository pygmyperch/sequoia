...
## Get started
*For a succinct version of this example where you can copy/paste all code in one go, see the [main vignette](./vignettes_blogdown/quick-start-examples.html)*
