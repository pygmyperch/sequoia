...
#' @param FortPARAM list with Fortran-ready parameter values, as generated by
                           ...
                           quiet)
{
  ...
  AgePriors <- MakeAgePrior(MaxAgeParent=10, Plot=FALSE, quiet=TRUE)

  Ng <- nrow(GenoM)
  gID <- rownames(GenoM)

  DUP <- .Fortran(duplicates,
                  ng = as.integer(FortPARAM$Ng),
